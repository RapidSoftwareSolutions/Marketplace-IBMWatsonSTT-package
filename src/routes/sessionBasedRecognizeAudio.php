...
$app->post('/api/IBMWatsonSTT/sessionBasedRecognizeAudio', function ($request, $response, $args) {
    
    $settings = $this->settings;
    
    $checkRequest = $this->validation;
    $validateRes = $checkRequest->validate($request, ['username','password','sessionId','cookies','audioFile','audioType'], true);
