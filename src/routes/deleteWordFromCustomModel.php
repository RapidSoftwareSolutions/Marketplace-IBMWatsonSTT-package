...
$app->post('/api/IBMWatsonSTT/deleteWordFromCustomModel', function ($request, $response, $args) {
    ...
    try {
        ...
        if(in_array($resp->getStatusCode(), ['200', '201', '202', '203', '204'])) {
            ...
            $result['contextWrites']['to'] = 'custom word was successfully deleted from the custom model.';
